...
{
    public const int TotalInventorySlots = 20;
    public const int InventoryColumns = 5;

    public const float InventoryCooldown = 1;
    public const float ItemDropCooldown = 0.3f;
    public const float ItemDropDelay = 0.3f;
    ...
    public const float MessageLifespan = 10;
}